...
Tests the ScaledChordProgression class and build_arpeggio_from_chord function.
"""
...
class TestArpeggiateChord(unittest.TestCase):
    """Tests for the build_arpeggio_from_chord function."""
...
class TestIntegration(unittest.TestCase):
    """Integration tests combining ScaledChordProgression and build_arpeggio_from_chord."""
